...
\begin{itemize}
	\item \textbf{screening attivo} per $\gamma c / a > m_e c^2 / \hbar $, cio\`e
		\[
		\gamma > \frac{m_e c}{\hbar } a \simeq \frac{192}{Z^{1 / 3} }\equiv \gamma_c \Rightarrow E_c = m_e \gamma_c > \frac{98}{Z^{1 / 3} } \text{ MeV}
		\] 
	con $E_c$ energia critica, cio\`e energia sopra cui si verifica una notevole perdita di energia;
