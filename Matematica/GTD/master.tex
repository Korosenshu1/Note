...
\begin{proof}
	...
	Per vederlo, si prende $x \in \partial M$ e $g : U \to M $ una parametrizzazione locale attorno a $x = g(u)$, dove $u \in \partial U := U \cap \partial H^m$, che \`e un aperto di $\mathbb{R}^{m-1} $.
\end{proof}
\begin{boxenv}[]
