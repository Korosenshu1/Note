...
\] 
\begin{esercizio}
	Sia $M$ una variet\`a; allora $M \times [0,1]$ \`e una variet\`a con bordo $\partial M = M \times \left\{ 0 \right\} \cup M \times \left\{ 1 \right\} $.
\end{esercizio}
\begin{svolgimento}
...
\end{definizione}
\begin{boxenv}[]
	\centering \color{nred} Riprendere dalla lezione 25
\end{boxenv}
