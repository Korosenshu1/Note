...
L'obiettivo \`e quello di arrivare a dimostrare il teorema di Brower, il quale afferma che una generica mappa continua 
\[
...
\begin{boxenv}[]
	\centering \color{nred} Riprendere dalla lezione 24
\end{boxenv}
