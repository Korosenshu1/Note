...
\end{prop}
\begin{proof}
	Avendo $n,m < +\infty$, si pu\`o considerare $FL$ come un $L$-spazio vettoriale generato da $n$ elementi, per cui si ricava che $FL$ \`e anche un $K$-spazio vettoriale di dimensione finita.
	In particolare, applicando due volte la proposizione \ref{text} all'estensione
	\[
	\begin{tikzcd}
		&  FL  & \\
		L  & &  F \\
	...
	\end{tikzcd}
	\] 
	si ha che $m \mid d$ e $n \mid d$, da cui la tesi.
\end{proof}
