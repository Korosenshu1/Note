...
\end{proof}
\end{prop}
\noindent Un caso particolare di omomorfismo canonico \`e la \textbf{proiezione canonica} $\pi$ che, dati $G$ un gruppo e $N \subset G$ un suo sottogruppo normale, mappa $G \to G / N$.
Questo permette di definire un diagramma commutativo come conseguenza del \textit{primo teorema di omomorfismo}; infatti, si ha:
\[\begin{tikzcd}
	G && {\operatorname{Im}f} \\
	\\
...
\end{definizione}
\begin{center}
	Riprendere dal corollario 10.1.4, pagina 95.
\end{center}
