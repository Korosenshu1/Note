...
\begin{corollario}
	...
	1 = a'm + b'n 
	\] 
	per cui $1$ \`e ilpi\`u piccolo intero positivo  ottenibile come combinazione lineare positiva di $a', b'$, quindi i due sono coprimi.
	\end{proof}
\end{corollario}
\begin{teorema}
	{}{d1}
...
Al contrario, si nota facilmente che una qualunque coppia della forma $\left( - \frac{b}{\operatorname{gcd}(a,b) }t , \frac{a}{\operatorname{gcd}(a,b) }t\right), \ t \in \mathbb{Z} $ \`e una soluzione dell'omogenea associata. 
...
\subsection{Teorema cinese del resto e classi di resto}
