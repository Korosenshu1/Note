...
\begin{prop}
	...
	\] 
			...
			\end{proof}
\end{prop}
\noindent Da questa proposizione, segue direttamente che se $\rho ,\sigma  \in D_n$, allora $\langle \rho ,\sigma  \rangle< D_n$

Grazie alla precedente proposizione, \`e anche possibile definire $\rho ^{[i]} = \rho ^i$, con $[i] \in \mathbb{Z} / n\mathbb{Z}$, visto che $\rho ^n = e$.
\end{document}
