...
Si cerca un cambio di base da $\ket{j_1, m_1} \otimes \ket{j_2,m_2} = \ket{j_1,j_2,m_1,m_2} $ a $\ket{j_1,j_2,J,M} $, con $J$ riferito a $\hat{J} = \hat{J}_1 + \hat{J}_2$ e $M$ a $\hat{J}_z$, che \`e utile quando il sistema \`e invariante per rotazioni.
...
\subsubsection{Buca di potenziale $V_0$}
