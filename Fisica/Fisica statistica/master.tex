...
\end{osservazione}
Sotto approssimazione di $\psi $ piccoli, si pu\`o scrivere la $f(\psi )$ sviluppando con Taylor il termine con $\log\left(\cosh \psi\right) $, da cui si ricava
\[
...
\subsubsection{Applicazione al modello di Ising}
...
\begin{boxenv}[]
	\centering Riprendere da lezione 13 -13:29
\end{boxenv}
