...
\end{teorema}
\begin{osservazione}
Questo teorema permette di concludere che un'eventuale transizione di fase, per un sistema del tipo previsto dal teorema, pu\`o verificarsi esclusivamente per $z=1$.
\end{osservazione}
