...
Si fa uso della base dei numeri di occupazione $\left\{ n_\lambda  \right\} _{\lambda} $, per cui $\ket{n_0,\, n_1 ,\, n_2,\,\ldots} $ \`e lo stato, detto \textit{stato di Fock}, del sistema i cui livelli energetici $\lambda =0,1,\ldots$ sono popolati con i rispettivi $n_\lambda $.
...
\end{osservazione}
\begin{osservazione}
A meno di specificare regole di commutazione/anti-commutazione, gli operatori di creazione e distribuzione sono generali e non sono riferiti a bosoni, o fermioni.
\end{osservazione}
\subsubsection{Cambio di base}
Date le basi $\left\{ \ket{\lambda }  \right\} , \ \left\{ \ket{\lambda '}  \right\} $, facendo uso della relazione di completezza, si ha
\[
...
\begin{boxenv}[]
\centering Riprendere dalla lezione 26
\end{boxenv}
