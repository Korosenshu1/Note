...
\subsubsection{Catena di Kitaev}
...
\begin{center}
	\begin{tikzpicture}
		...
		\foreach \j in {0,2,4,6,8}{
			\draw[very thick,blue!60!gray,opacity=0.4] ({\j+0.15},-1.2) -- ({\j+2-0.15},-1.2);
		}
		\draw[very thick,red!60!gray,opacity=0.4] (-0.15,-1.2) -- (-0.4,-1.2);
		\draw[very thick,red!60!gray,opacity=0.4,dotted] (-0.4,-1.2) -- (-0.6,-1.2);
		\draw[very thick,red!60!gray,opacity=0.4] ({10+0.15},-1.2) -- ({10+0.4},-1.2);
		\draw[very thick,red!60!gray,opacity=0.4,dotted] ({10+0.4},-1.2) -- ({10+0.6},-1.2);
...
La costruzione di questa catena \`e legata a \textit{Kitaev}, da cui il nome.
\begin{osservazione}
Questa costruzione non \`e sempre possibile; per esempio, in questo caso, si \`e dovuto prendere $g=0$.
\end{osservazione}
\begin{boxenv}[]
\centering Riprendere dalla lezione 34
\end{boxenv}
