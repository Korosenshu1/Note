...
\end{teorema}
\begin{teorema}
Se $R$ \`e una regione del piano complesso in cui non sono presenti zeri di $\mathcal{Z} $, allora $\mathcal{F} _V(z)$ converge uniformemente sui compatti di $Rq$, per $V\to +\infty$.
\end{teorema}
