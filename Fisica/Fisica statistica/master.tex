...
\] 
per cui non si pu\`o pi\`u utilizzare il determinante di Slater e lo studio del problema in prima quantizzazione diventa molto difficile da trattare.
...
\begin{itemize}
	...
	\item Si assume che gli ioni siano tutti uguali, per cui si pu\`o imporre che 
		\[
		t^{\mathbf{R} ,\mathbf{R} '} _{n,m} = \delta _{nm} \delta _{\mathbf{R} ', \mathbf{R} \pm \mathbf{a} } t
		\] 
...
\[
\hat{c}^\dagger _{k,\sigma }  = \frac{1}{\sqrt{N} }\sum_{j}^{} e^{ik x_j}\hat{c}_{j,\sigma } ^\dagger \hspace{1cm} \hat{c}^\dagger _{k,\sigma }  = \frac{1}{\sqrt{N} }\sum_{j}^{} e^{-ik x_j}\hat{c}_{j,\sigma }  
\] 
