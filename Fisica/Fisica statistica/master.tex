...
\subsection{Teoria di Yang e Lee}
...
Indicando con $\zeta_1,\ldots,\zeta_M$ le sue radici, assumendo che siano tutte distinte, si pu\`o scrivere 
\[
\mathcal{Z} (z) = \prod_{N=1} ^M \left(1-\frac{z}{\zeta_N}\right) 
\] 
