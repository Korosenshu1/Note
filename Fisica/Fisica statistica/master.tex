...
\[
	...
	\end{split}
\] 
dove $T_k = \braket{S_k|T|S_{k+1} } $ e $O_n$ \`e una matrice relativa al fattore $S_n$ nell'espressione alla prima riga, che conta gli stati dello spin $n$-esimo; questa si pu\`o scrivere come
\[
...
\] 
relazione ottenuta valutando il seguente risultato per la serie geometria 
\[
