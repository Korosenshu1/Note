...
\subsubsection{Effetto M\"ossbauer}
Consiste nell'emissione di raggi $\gamma$ da un nucleo e dal conseguente assorbimento di questi da parte di un altro nucleo. L'emissione di $\gamma$ da nucleo pu\`o avvenire come $\ce{_Z^AX^*_N} \to \ce{_Z^AX_N} + \gamma $ oppure con
\[
...
\end{split}
\] 
Si considera in particolare il caso in cui \ldots
