...
\end{equation*}
	  Per $g<0$, lo stato fondamentale del sistema non esiste pi\`u.
  \end{minipage}
{\hspace{2cm}}
...
\] 
	   ...
	   in un dominio $D \subset \mathbb{C}$ e con $f(z)$ analitica in $D$, come nel caso dell'oscillatore anarmonico, i primi termini dello sviluppo forniscono una buona approssimazione del problema per $g$ relativamente piccolo.
   \end{frame}
\end{document}
