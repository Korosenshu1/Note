...
%   \end{frame}
   \begin{frame}
	   ...
	   \vspace{.25cm}
	   Si nota, per\`o, che questo non rende vano lo sviluppo: qualora la serie fosse asintotica come nel caso dell'oscillatore anarmonico, i primi termini dello sviluppo forniscono una buona approssimazione del problema per $g$ relativamente piccolo.	
   \end{frame}
\end{document}
